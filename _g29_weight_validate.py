    ...
    try:
        ...
        class TempModel(nn.Module):
            def __init__(self, input_size):
                super().__init__()
                self.fc1 = nn.Linear(12, 10)  # Example - REPLACE with your layers
                self.fc2 = nn.Linear(10, 5)  # Example - REPLACE with your layers
                self.fc3 = nn.Linear(5, 2)  # Example - REPLACE with your layers
        ...
        temp_model = TempModel(details["input_size"])
...
def weight_flipping_attack(model_path, attack_percentage=0.1):
    try:
        state_dict = torch.load(model_path, weights_only=True)
    except FileNotFoundError:
        return {"error": f"Model file not found at {model_path}"}
    ...
    attacked_model_path = "poisson_" + model_path
...
if __name__ == "__main__":
    ...
    # Example TempModel - REPLACE with your actual model structure
    class TempModel(nn.Module):
        def __init__(self, input_size):
            super().__init__()
            self.fc1 = nn.Linear(12, 10)  # Example
            self.fc2 = nn.Linear
